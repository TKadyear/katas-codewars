...
describe('Phone Number', () => {
  ...
  test('If length of the list numbers is bigger than 9', () => {
    expect(createPhoneNumber([1, 2, 3, 4, 5, 6, 7, 8, 9, 0])).toEqual('Phone Number must have only 9 digits');;
  })
  test('If some of the numbers is bigger than 9', () => {
    expect(createPhoneNumber([1, 2, 3, 40, 5, 6, 7, 8, 9, 0])).toEqual('Phone Number must have only 9 digits');;
  })
  test('If the list has a NaN', () => {
  ...
  test('If the list has a Boolean', () => {
    expect(createPhoneNumber([1, true, 3, 4, 5, 6, 7, 8, 9, 0])).toEqual('Invalid Phone Number');
  })
})
